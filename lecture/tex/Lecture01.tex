...
\begin{frame}
    ...
    \begin{figure}
        \begin{circuitikz}[node distance = 2mm and 2mm]
            % DC/AC converter (three-phase)
            \draw (0,0) node[tdcacshape] (conv) {};

            % Three-phase motor (anchored so its ac anchors align with converter)
            \node[threephasemotorshaftshape] (motor) at (4,0) {};
            % Bended arrow right of the motor shaft pointing downwards
            ...
            % Three-phase connections: straight horizontal lines
