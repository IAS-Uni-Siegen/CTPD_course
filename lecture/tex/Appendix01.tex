...
\begin{frame}
    ...
    A RK method is called \hl{implicit} if $\alpha_{j,l}\neq 0$ for some $l\geq j$, which requires to solve implicit equations for the stage derivatives $\bm{h}_j$. Implicit methods are typically more computationally expensive per step but can offer better stability properties.\\\pause
