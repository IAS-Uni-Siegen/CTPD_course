...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Flux saturation animation %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
    \frametitle{Flux saturation in electric machines: animation}
    \begin{figure}
        \centering
...
\begin{frame}
    ...
    The model \eqref{eq:basic_PMSM_model_set} is called the \hl{fundamental wave model} since it only considers the fundamental spatial harmonic of the flux linkage distribution. However, in a real machine multiple rotor angle-dependent effects shape the flux linkage distribution:
    \begin{itemize}
        \item Design: slot and winding distribution impacts, motor skew along the axial direction, etc.,
        \item Production: geometry and material tolerances, assembly inaccuracies, etc.
    \end{itemize}
    \begin{figure}
        \begin{tikzpicture}
            \begin{groupplot}[
...
\begin{frame}
    ...
    \end{equation}
    Consequently, the time derivative of the flux linkage becomes
    \begin{equation}
        \begin{split}
            \frac{\mathrm{d}}{\mathrm{d}t}\bm{\psi}_\mathrm{s,dq}(t) & = \frac{\partial \bm{f}_{\psi_\mathrm{s}}}{\partial \bm{i}_\mathrm{s,dq}}\bigg|_{\varepsilon}\frac{\mathrm{d}}{\mathrm{d}t}\bm{i}_\mathrm{s,dq}(t) + \frac{\partial \bm{f}_{\psi_\mathrm{s}}}{\partial \varepsilon}\bigg|_{\bm{i}_\mathrm{s,dq}}\frac{\mathrm{d}}{\mathrm{d}t}\varepsilon(t) \\ & = \bm{L}(\bm{i}_\mathrm{s,dq}, \varepsilon)\frac{\mathrm{d}}{\mathrm{d}t}\bm{i}_\mathrm{s,dq}(t) + \frac{\partial \bm{f}_{\psi_\mathrm{s}}}{\partial \varepsilon}(\bm{i}_\mathrm{s,dq}, \varepsilon)\omega(t).
        \end{split}
    \end{equation}
    Thus, the flux linkage harmonics introduce an additional induced voltage term into the stator voltage equation:
    \begin{equation}
        \begin{split}
            \bm{u}_\mathrm{s,dq}(t) & = R_\mathrm{s} \bm{i}_\mathrm{s,dq}(t)+ \omega(t)\bm{J}\bm{\psi}_\mathrm{s,dq}(t) + \frac{\mathrm{d}}{\mathrm{d}t}\bm{\psi}_\mathrm{s,dq}(t) \\ & = R_\mathrm{s} \bm{i}_\mathrm{s,dq}(t)+ \omega(t)\bm{J}\bm{f}_{\psi_\mathrm{s}}(\bm{i}_\mathrm{s,dq}(t), \varepsilon(t)) + \bm{L}(\bm{i}_\mathrm{s,dq}, \varepsilon)\frac{\mathrm{d}}{\mathrm{d}t}\bm{i}_\mathrm{s,dq}(t) + \frac{\partial \bm{f}_{\psi_\mathrm{s}}}{\partial \varepsilon}\omega(t).
        \end{split}
    \end{equation}
\end{frame}
